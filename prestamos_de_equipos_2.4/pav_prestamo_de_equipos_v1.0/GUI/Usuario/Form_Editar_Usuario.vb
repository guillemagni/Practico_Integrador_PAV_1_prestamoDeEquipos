...
Public Class Form_Editar_Usuario
    ...
    Private Sub btn_buscar_Click(sender As Object, e As EventArgs) Handles btn_buscar.Click
        ...
        'Dim cadena As String = "SELECT nombreUsuario, contraseña, nombrePerfil, apellidoPerfil FROM Usuario WHERE nombreUsuario='" & cod & "'"

        'cmd = New SqlCommand(cadena, cnn)
        'Dim registro As SqlDataReader
        'registro = cmd.ExecuteReader()
        'If registro.Read() Then
        '    If (registro("nombrePerfil").ToString = "") Then
        '        txt_box_nombre.Text = "Campo vacío"
        '    Else
        '        txt_box_nombre.Text = registro("nombrePerfil")
        '    End If

        '    If (registro("apellidoPerfil").ToString = "") Then
        '        txt_box_apellido.Text = "Campo vacío"
        '    Else
        '        txt_box_apellido.Text = registro("apellidoPerfil")
        '    End If
        '    txt_box_pass.Text = registro("contraseña")
        '        txt_box_nick.Text = registro("nombreUsuario")
        '        ' lbl_mensaje = "Estos son los datos actuales. Modifique los datos."
        '    Else
